...
| [`checklist.json`](checklist.json) | Table IV items with citation-removal test |
| [`reliability.json`](reliability.json) | Second-coder raw agreement + Cohen’s κ + bootstrap CI |
