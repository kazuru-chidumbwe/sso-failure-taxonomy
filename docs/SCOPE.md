...
- An **open falsifiability path**: external fingerprint-safe incidents against Table II (`docs/EXTERNAL-INCIDENTS.md` + GitHub issue template). Outcomes are not claimed as manuscript evidence.
...
- Independent taxonomy discovery. Second-coder agreement is label assignment given Table II.
