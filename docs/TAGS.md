...
| Tag | Role |
| --- | --- |
| `v1.0.14` | **A2 complete.** Human `coder-a.json` + `coder-b.json`; `reliability-external-v1.json` overlap stats. Zenodo version DOI `10.5281/zenodo.22544007`. N=11 frozen at `v1.0.12`. |
