...
| Tag | Role |
| --- | --- |
| `v1.0.14` | **A2 complete.** Human `coder-a.json` + `coder-b.json`; `reliability-external-v1.json` overlap stats. Wire new Zenodo version DOI into manuscript [38] after release. N=11 frozen at `v1.0.12`. |
