...
| Tag | Role |
| --- | --- |
| `v1.0.16` | **Corpus provenance v2.** 35 live-harvested + 30 author-constructed; `validate_corpus_provenance.py`. Wire Zenodo version DOI into manuscript [38] after release. N=11 frozen at `v1.0.12`. |
