...
**Manuscript cite pin:** tag **`v1.0.28`** (or latest release) · Zenodo version DOI in manuscript [23]  
...
| `codebook/stress-cases.json` | S1–S8 decision-test battery + D1–D4 negative decoys |
| `codebook/validate_catalog_assignments.py` | Catalog + decision-test + corpus manifest conformance checker (`make smoke`) |
| `codebook/checklist.json` | Table XI practitioner checklist |
...
Verification is **artifact specification tests** (S1–S10, D1–D4, catalog/corpus conformance checks, synthetic mechanism demonstrations), not inter-rater agreement studies.
